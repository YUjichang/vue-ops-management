...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        meta: { title: '主机管理', icon: 'computer' }
      },
      {
        path: 'import',
        name: 'HostImport',
        component: () => import('@/views/host/import/index'),
        meta: { title: '批量导入' },
        hidden: true
      }
    ]
...

  {
    ...
    children: [{
      ...
      meta: { title: '文件中心', icon: 'documentation' }
    }]
  },
...

  {
    path: '/novnc',
    name: 'NoVnc',
    component: () => import('@/views/novnc/index'),
    hidden: true
  },
    ...
    children: [
      {
        ...
        meta: { title: '系统监控', icon: 'Prometheus' }
      },
      {
        path: 'grafana',
        name: 'MonitorsGrafana',
        component: () => import('@/views/monitor/grafana/index'),
        meta: { title: 'grafana图表', icon: 'grafana' }
      }
    ]
  }
]
